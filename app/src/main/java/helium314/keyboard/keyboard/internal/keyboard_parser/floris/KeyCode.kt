...
object KeyCode {
    ...
    // PravkaBoard: Claude-powered proofreading and live dictation
    const val PRAVKA_CLEAN =              -10060
    const val PRAVKA_VOICE =              -10061
    const val PRAVKA_SHORTER =            -10062
    ...
    const val PRAVKA_SETTINGS =           -10069  // open the keyboard settings at the Pravka screen
    ...
    fun Int.checkAndConvertCode(longPress: Boolean = false): Int = if (this > 0) this else when (this) {
        ...
        PRAVKA_NUM_INERT, PRAVKA_SETTINGS,
        -> this
