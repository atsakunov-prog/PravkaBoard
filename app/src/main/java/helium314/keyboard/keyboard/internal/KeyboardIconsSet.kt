...
//            NAME_PREVIOUS_KEY to                null,
            ...
            ToolbarKey.entries.forEach {
                put(it.name.lowercase(Locale.US), when (it) {
                    ...
                    ToolbarKey.PRAVKA_NUMROW -> R.drawable.sym_keyboard_numpad_key_holo
                    ToolbarKey.PRAVKA_SETTINGS -> R.drawable.ic_pravka_settings
                    ...
                    ToolbarKey.PRAVKA_SELECT -> R.drawable.ic_arrow_horizontal
                })
            }
        } }
...
//            NAME_SPACE_KEY to                   null,
            ...
            ToolbarKey.entries.forEach {
                put(it.name.lowercase(Locale.US), when (it) {
                    ...
                    ToolbarKey.PRAVKA_LONGER -> R.drawable.ic_pravka_longer
                    ToolbarKey.PRAVKA_POLISH -> R.drawable.ic_pravka_polish
                    ToolbarKey.PRAVKA_SELECT -> R.drawable.ic_arrow_horizontal_rounded
                })
            }
        } }
