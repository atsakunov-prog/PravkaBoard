...
- **Повторы**: таблица «слово | 1-й | 2-й | 3-й | Δ» на экране списка и на экране прогресса плюс
  фраза «второй раз то же слово Боря пишет в среднем на N% быстрее». Слова объединяются по тексту,
  так что одно и то же слово из разных списков тоже сравнивается.
- **Бумажная статистика** сентября 2026 уже загружена (11 русских замеров, 11 английских и второй
  проход трёх первых английских слов), новые бумажные результаты добавляются кнопкой
